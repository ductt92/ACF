...
import {
  MOCK_FOOTER_SUPPORT_EN,
  MOCK_FOOTER_SUPPORT_VI,
} from '@/contants/mock-data/mock-data';
const FooterSupport = () => {
  const { lang, t } = useTranslation('common');
  const dataFooterSupport =
    lang === 'vi' ? MOCK_FOOTER_SUPPORT_VI : MOCK_FOOTER_SUPPORT_EN;
  return (
    <div className='float-left inline-block w-[311px] sm:hidden lg:w-[20%]'>
      ...
      <ul className='float-left h-[135px] w-full pt-[20px]'>
        {dataFooterSupport.map((value, index) => (
          <div
            key={index}
